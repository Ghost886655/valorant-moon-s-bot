...
async def q(ctx):
    if str(ctx.channel) == "pugs" or str(ctx.channel) == "fixing-bugs" or str(ctx.channel) == "bot-commands":
        ...
        if len(queue) < size*2-1:
            ...
            for i in team_1:
                queue.remove(i)
            teams = discord.Embed(title="קבוצה A", description=', '.join(team_1), inline=False, color=discord.Color.red())
            ...
            if map == 1:
                ...
                teams.set_image(url="https://cdn.discordapp.com/attachments/730106200053645334/819624847973154872/Z.png")
            if map == 2:
                teams.add_field(name="מפה:", value="Icebox")
                teams.set_image(url="https://cdn.discordapp.com/attachments/730106200053645334/819626129618763886/9k.png")
            if map == 3:
                teams.add_field(name="מפה:", value="Ascent")
                teams.set_image(url="https://cdn.discordapp.com/attachments/730106200053645334/819625519359459339/2Q.png")
            if map == 4:
                teams.add_field(name="מפה:", value="Haven")
                teams.set_image(url="https://cdn.discordapp.com/attachments/730106200053645334/819625851481358346/2Q.png")
            if map == 5:
